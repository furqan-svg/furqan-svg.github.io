...
(function () {
    ...
    const EMAIL = 'syedfurqan246@gmail.com';
    ...
    const COMMANDS = {
        ...
        whoami: () => [
            ['t-accent', 'Syed Furqan'],
            ['', 'AI & Data Science Student — Chennai, India'],
        ...
        blog: () => [['', 'blog is currently paused / coming soon!']],
        github: () => { window.open('https://github.com/furqan-svg/', '_blank', 'noopener'); return [['', 'opening github.com/furqan-svg ↗']]; },
        linkedin: () => { window.open('https://www.linkedin.com/in/syed-furqan-231631349/', '_blank', 'noopener'); return [['', 'opening linkedin.com/in/syed-furqan-231631349 ↗']]; },
        medium: () => [['', 'blog is currently paused / coming soon!']],
        theme: () => {
