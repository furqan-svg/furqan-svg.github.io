        ...
        return [
            ...
            },
            {
                group: 'RUN', icon: '$', label: 'download_resume --pdf', hint: 'file', run: () => {
                    ...
                    a.download = 'Syed_Furqan_2026.pdf';
            ...
            { group: 'CONNECT', icon: '@', label: 'github.com/furqan-svg', hint: '↗', run: () => window.open('https://github.com/furqan-svg/', '_blank', 'noopener') },
            { group: 'CONNECT', icon: '@', label: 'linkedin.com/in/syed-furqan', hint: '↗', run: () => window.open('https://www.linkedin.com/in/syed-furqan-231631349/', '_blank', 'noopener') },
            // { group: 'CONNECT', icon: '@', label: 'blog.html', hint: '↗', run: () => { window.location.href = 'blog.html'; } },
            { group: 'CONNECT', icon: '@', label: 'mail syedfurqan246@gmail.com', hint: '✉', run: () => { window.location.href = 'mailto:syedfurqan246@gmail.com'; } },];
    }
